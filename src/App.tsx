        ...
        <AuthProvider>
          <Routes>
            ...
            <Route
              path="/admin"
              element={
                <ProtectedRoute allowedRoles={['admin', 'business_analyst']}>
                  <Layout>
                    <AdminPanel />
                  </Layout>
                </ProtectedRoute>
            ...
            <Route
              path="/purchase/queue"
              element={
                <ProtectedRoute allowedRoles={['procurement_manager', 'coo', 'ceo', 'treasurer', 'chief_accountant', 'finance_deputy', 'accountant', 'admin', 'business_analyst', 'admin_director']}>
                  <Layout>
